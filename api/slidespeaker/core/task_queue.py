...
class RedisTaskQueue:
    ...
    def get_next_task(self) -> Optional[str]:
        ...
        try:
            ...
            task_id = self.redis_client.blmove(
                self.queue_key, 
            ...
            task_id = self.redis_client.brpoplpush(self.queue_key, f"{self.queue_key}:processing", timeout=1)
        return task_id
    ...
    def complete_task_processing(self, task_id: str) -> bool:
        ...
        self.redis_client.lrem(f"{self.queue_key}:processing", 1, task_id)
        return True
    ...
    def cancel_task(self, task_id: str) -> bool:
        ...
        if task["status"] == "queued":
            # Remove from queue
            self.redis_client.lrem(self.queue_key, 1, task_id)
            ...
            self.redis_client.setex(cancellation_key, 300, "true")  # Expire after 5 minutes
