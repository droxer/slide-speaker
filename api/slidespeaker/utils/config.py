...
class Config:
    ...
    def output_dir(self) -> Path:
        """Get the output directory path, configurable via OUTPUT_DIR environment variable"""
    ...
    def uploads_dir(self) -> Path:
        """Get the uploads directory path, configurable via UPLOADS_DIR environment variable"""
